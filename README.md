# Swiggy-Vadodara-Exploratory-Data-Analysis
...
From the provided URL, names and ratings were extracted which were visible on the front page of the website. The data for each of the restaurants on the swiggy were recorded in the csv file, so that later the data can be extracted individually for each restaurant.
